<h1>Introduction</h1>
<div>
  The fx-CP400 calculator has the ability to display images within certain CASIO applications. It can not use common formats, like PNG or JPG, it can however use the CASIO C2P format instead.
  ...
  While there is official software by CASIO available for converting images to C2P and C2B, these programs require a special password that is supposed to be given by your teacher.
  The C2P converter is based on <a href="https://github.com/the6p4c/Kalkimg">this repository by the6p4c</a>, the C2B converter was done by myself. It only requires that you have Rust installed and a fx-CP400 calculator (with a USB cable).
</div>
...
<div>
  ...
  <p>Now you have your image as a C2P/C2B file. In the next steps you will need your calculator.</p>
  
  <ol>
    <li>
      plug in the calculator with the USB cable to your PC
    </li>
    <li>
    ...
    <li>
      drag your C2P/C2B file in there
    </li>
    <li>
...
<div>
  C2P and C2B files have similar requirements. They need:
  <ul>
    <li>
      a valid size (max. 310 x 401), however if you use my program it will scale down images that are too large
    </li>
    <li>
  ...
  <a href="https://cdn.ti-planet.org/downloads2/1406770160/Classpad.c2pimagefileformat.pdf">Here are the necessary bytes for your file</a> (mind the bytes that change in the header)
  ...
  <ul>
    ...
    <li>
      ...
      *this is the same for every C2B file, however, there are some bytes that have an effect on the environment inside the 'Picture Plot' application (some bytes change the window dimensions, grid position, etc., no effect on picture itself)
    </li>
  </ul>
</div>
...
<br>
<hr>
<p>If you have any tips for improvement or problems, please open an issue!</p>
